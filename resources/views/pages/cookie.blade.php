        ...
        <div class="pt-40 pb-20 relative overflow-hidden">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <p class="text-xl text-gray-500 max-w-2xl leading-relaxed">
                    We use cookies to enhance your experience. This document explains what they are, how we use them,
                    ...
                    <div class="sticky top-32">
                        ...
                        <nav class="space-y-6">
                            <a href="#definition" class="group flex items-center gap-3">
                                ...
                                <span class="text-sm font-bold text-dark group-hover:px-2 transition-all">1. What are
                                    cookies</span>
                            </a>
                ...
                <div
                    ...
                    <section id="usage" class="mb-24">
                        ...
                        <div class="text-lg leading-relaxed text-black/80 space-y-6">
                            <p>Anntix uses cookies for several vital reasons, ranging from core security to personalized
                                discovery.</p>
                            <p>We do not store personally identifiable information that could be used by others to harm
                                your digital identity.</p>
                        </div>
                    </section>
                    ...
                    <div
                        ...
                        <div class="md:text-right">
                            <div class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Last Modified
                            </div>
