    ...
    <div class="max-w-7xl mx-auto space-y-8 pb-12">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            @if($financial['available_saldo'] > 0)
                <a href="{{ route('admin.events.withdrawals.create_for_event', $event) }}"
                    class="flex items-center gap-2 px-5 py-3 bg-primary text-white hover:bg-dark rounded-2xl font-black text-xs uppercase tracking-widest transition-all shadow-lg shadow-primary/20 self-start md:self-auto">
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div>
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <span class="text-xs font-black text-dark">{{ $financial['online_tickets_sold'] }} tiket</span>
                    </div>
                ...
                <div>
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <span class="text-xs font-black text-dark">{{ $financial['reseller_tickets_sold'] }} tiket</span>
                    </div>
                    <div class="w-full bg-gray-100 rounded-full h-2 mb-1">
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-5 border-b border-gray-100 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-1">Admin self-record — bookkeeping only</p>
                </div>
            </div>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-5 border-b border-gray-100">
                <h2 class="text-sm font-black text-dark uppercase tracking-wider">Withdrawal History</h2>
                <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-1">{{ $withdrawals->count() }} total requests</p>
            </div>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        @forelse($withdrawals as $w)
                            <tr class="hover:bg-primary/[0.02] transition-colors group" x-data="{ showApprove: false, showReject: false }">
                                <td class="px-6 py-4">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-16 text-center">
                                    ...
                                    <p class="text-gray-400 font-bold text-sm">No withdrawal history found for this event.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
