<x-layouts.admin>
    <div class="max-w-5xl mx-auto space-y-8 pb-12">
        <!-- Back Link -->
        <div>
            <a href="{{ route('admin.events.tickets.index', $event) }}" class="inline-flex items-center text-sm font-bold text-gray-400 hover:text-primary transition-colors gap-2">
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-gray-50 border-b border-gray-100 text-xs uppercase text-gray-500 font-bold tracking-wider">
                            ...
                            <th class="px-6 py-4 text-dark text-right rounded-tr-xl">Amount</th>
                        </tr>
                    </thead>
