<x-layouts.admin>
    <div class="max-w-xl mx-auto">
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-dark">Edit Scanner</h1>
        </div>

        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
            <form action="{{ route('admin.scanners.update', $scanner) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-2">
                    <label for="password" class="text-sm font-bold text-dark uppercase tracking-wide">
                        Password <span class="text-gray-400 font-normal lowercase">(Leave blank to keep current)</span>
                    </label>
