    ...
    <div x-data="{ deleteModalOpen: false, formToSubmit: null }">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
            ...
            <a href="{{ route('admin.events.create') }}"
                class="w-full sm:w-auto text-center px-6 py-2 bg-primary text-white font-bold rounded-xl hover:bg-primary-700 transition-colors shadow-lg shadow-primary/25">
                + Create Event
            </a>
        </div>
