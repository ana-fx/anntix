        ...
        <form action="{{ route('admin.events.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div x-data
                        x-init="flatpickr($refs.picker, { enableTime: true, dateFormat: 'Y-m-d H:i', time_24hr: true, minDate: 'today', altInput: true, altFormat: 'd M Y, H:i' })">
            ...
            <!-- 6. Fees & Commission -->
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div x-data="{
                            open: false,
                            selected: '{{ old('organizer_fee_type', 'fixed') }}',
                            label: '{{ old('organizer_fee_type') == 'percent' ? 'Percent (%)' : 'Fixed' }}'
                        }" class="relative">
