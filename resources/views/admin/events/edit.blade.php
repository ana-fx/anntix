        ...
        <form action="{{ route('admin.events.update', $event) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div x-data="{ on: {{ $event->is_online_sales_enabled ? 'true' : 'false' }} }"
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        @php
                            $curOrgId = old('organizer_id', $event->organizer_id);
                            $curOrgLabel = $curOrgId ? ($organizers->firstWhere('id', $curOrgId)?->name ?? 'No Organizer Assigned') : 'No Organizer Assigned';
                        @endphp
                        <div x-data="{ open: false, value: '{{ $curOrgId }}', label: '{{ addslashes($curOrgLabel) }}' }" class="relative">
