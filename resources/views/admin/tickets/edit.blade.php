                ...
                <div x-data="{ showFees: true }">
                    ...
                    <div x-show="showFees" x-transition
                        ...
                        <div>
                            ...
                            @php $v = old('reseller_fee_type', $ticket->reseller_fee_type); $l = $v === 'fixed' ? 'Fixed' : ($v === 'percent' ? 'Percent (%)' : 'Use Default'); @endphp
                        ...
                        <div>
                            ...
                            @php $v = old('organizer_fee_online_type', $ticket->organizer_fee_online_type); $l = $v === 'fixed' ? 'Fixed' : ($v === 'percent' ? 'Percent (%)' : 'Use Default'); @endphp
                            <div x-data="{ open: false, value: '{{ $v }}', label: '{{ $l }}' }" class="relative">
                        ...
                        <div>
                            ...
                            @php $v = old('organizer_fee_reseller_type', $ticket->organizer_fee_reseller_type); $l = $v === 'fixed' ? 'Fixed' : ($v === 'percent' ? 'Percent (%)' : 'Use Default'); @endphp
                            <div x-data="{ open: false, value: '{{ $v }}', label: '{{ $l }}' }" class="relative">
                        ...
                        <div>
                            ...
                            @php $v = old('handling_fee_type', $ticket->handling_fee_type); $l = $v === 'fixed' ? 'Fixed' : ($v === 'percent' ? 'Percent (%)' : 'Use Default'); @endphp
                            <div x-data="{ open: false, value: '{{ $v }}', label: '{{ $l }}' }" class="relative">
