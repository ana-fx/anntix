                    ...
                    <div x-show="showFees" x-transition
                        ...
                        <div>
                            ...
                            <select name="reseller_fee_type" class="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all bg-white cursor-pointer">
                                ...
                                <option value="fixed" {{ old('reseller_fee_type', $ticket->reseller_fee_type) == 'fixed' ? 'selected' : '' }}>Fixed</option>
                                <option value="percent" {{ old('reseller_fee_type', $ticket->reseller_fee_type) == 'percent' ? 'selected' : '' }}>Percent (%)</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">Reseller Fee Value</label>
                            <input type="number" name="reseller_fee_value" value="{{ old('reseller_fee_value', $ticket->reseller_fee_value) }}" min="0" step="0.01" placeholder="Leave empty for default" class="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="organizer_fee_online_type" class="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all bg-white cursor-pointer">
                                ...
                                <option value="percent" {{ old('organizer_fee_online_type', $ticket->organizer_fee_online_type) == 'percent' ? 'selected' : '' }}>Percent (%)</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="number" name="organizer_fee_online" value="{{ old('organizer_fee_online', $ticket->organizer_fee_online) }}" min="0" step="0.01" placeholder="Leave empty for default" class="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all">
                        ...
                        <div>
                            ...
                            <select name="organizer_fee_reseller_type" class="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all bg-white cursor-pointer">
                                ...
                                <option value="percent" {{ old('organizer_fee_reseller_type', $ticket->organizer_fee_reseller_type) == 'percent' ? 'selected' : '' }}>Percent (%)</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="number" name="organizer_fee_reseller" value="{{ old('organizer_fee_reseller', $ticket->organizer_fee_reseller) }}" min="0" step="0.01" placeholder="Leave empty for default" class="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all">
                        ...
                        <div>
                            ...
                            <select name="handling_fee_type" class="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all bg-white cursor-pointer">
                                <option value="">Use Default</option>
                                <option value="fixed" {{ old('handling_fee_type', $ticket->handling_fee_type) == 'fixed' ? 'selected' : '' }}>Fixed</option>
                                <option value="percent" {{ old('handling_fee_type', $ticket->handling_fee_type) == 'percent' ? 'selected' : '' }}>Percent (%)</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">Handling Fee Value</label>
                            <input type="number" name="handling_fee_value" value="{{ old('handling_fee_value', $ticket->handling_fee_value) }}" min="0" step="0.01" placeholder="Leave empty for default" class="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all">
                        </div>
                    </div>
