    ...
    <div class="space-y-8">
        ...
        <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="site_name" value="{{ $settings['site_name'] ?? '' }}"
                            class="w-full px-5 py-4 bg-gray-50 border-gray-100 rounded-2xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all font-medium">
                    </div>

                    <div class="grid grid-cols-2 gap-6">
                        <div class="space-y-2">
                            <label class="text-xs font-black text-dark uppercase tracking-widest px-1">Logo</label>
                        ...
                        <div class="space-y-2">
                            <label class="text-xs font-black text-dark uppercase tracking-widest px-1">Favicon</label>
            ...
            <div class="flex justify-end pt-4">
                <button type="submit"
                    class="px-12 py-5 bg-blue-600 text-white font-black rounded-2xl shadow-xl shadow-blue-500/20 hover:bg-blue-700 hover:-translate-y-1 transition-all active:scale-95 text-lg uppercase tracking-widest">
                    Save Changes
                </button>
            </div>
        </form>
