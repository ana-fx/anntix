...
<head>
    ...
    <title>Management Login - {{ config('app.name', 'ANTIX') }}</title>
    ...
    <div
        ...
        <div class="w-full md:w-5/12 bg-dark p-12 text-white flex flex-col justify-between relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <div class="space-y-6">
                    <h1 class="text-5xl font-black leading-none tracking-tight">Access Your<br><span
                            class="text-primary">Management</span><br>Console.</h1>
                    ...
                    <div class="space-y-4 pt-8">
                        <div class="flex items-start gap-4">
                            ...
                            <p class="text-sm font-medium text-gray-400 leading-relaxed pt-1">This gateway is
                                exclusively for <span class="text-white font-bold">Administrators</span>, <span
                                    class="text-white font-bold">Resellers</span>, and <span
                                    class="text-white font-bold">Scanners</span>.</p>
                        </div>
                        <div class="flex items-start gap-4">
                            ...
                            <p class="text-sm font-medium text-gray-400 leading-relaxed pt-1">Event organizers and staff
                                can manage ticket sales, validation and event metrics here.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="relative z-10 pt-12">
                <div class="p-6 bg-white/5 border border-white/10 rounded-[2rem] backdrop-blur-md">
                    <p class="text-xs font-black uppercase tracking-[0.2em] text-primary mb-2">Buying Tickets?</p>
                    <p class="text-xs text-gray-400 leading-relaxed mb-4">You don't need an account to purchase tickets.
                        Simply find your event and buy it directly!</p>
                    <a href="{{ route('home') }}"
        ...
        <div class="w-full md:w-7/12 bg-white p-12 lg:p-20 flex flex-col justify-center relative">
            ...
            <div class="max-w-sm mx-auto w-full">
                <div class="mb-12">
                    <h2 class="text-3xl font-black text-dark tracking-tight uppercase">Sign In</h2>
                    <p class="text-primary mt-2 font-medium">Please enter your management credentials.</p>
                </div>
                ...
                <form method="POST" action="{{ route('login.store') }}" class="space-y-6">
                    ...
                    <div class="space-y-2 group">
                        <label for="email"
                            class="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 group-focus-within:text-primary transition-colors ml-1">Email
                            Address</label>
                        <div class="relative">
                    ...
                    <div class="space-y-2 group" x-data="{ show: false }">
                        <div class="flex items-center justify-between px-1">
                            <label for="password"
                                class="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 group-focus-within:text-primary transition-colors">Password</label>
                            <a href="#"
                                class="text-[10px] font-black uppercase tracking-[0.1em] text-gray-400 hover:text-primary transition-colors">Forgot?</a>
                        </div>
                        <div class="relative">
                    ...
                    <div class="flex items-center pt-2">
                        <label class="flex items-center gap-3 cursor-pointer group">
                            ...
                            <span
                                class="text-xs font-black uppercase tracking-widest text-gray-500 group-hover:text-dark transition-colors">Stay
                                Signed In</span>
                        </label>
                    </div>
                ...
                <div class="mt-12 text-center">
                    <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest leading-loose">
                        &copy; {{ date('Y') }} ANTIX SECURITY PLATFORM.<br>
