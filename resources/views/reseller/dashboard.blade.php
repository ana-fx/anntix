                                    ...
                                    <tr class="group hover:bg-gray-50/50 transition-colors">
                                        <td class="px-8 py-6">
                                            <div class="flex items-center gap-4">
                                                ...
                                                @endphp
                                                <div class="relative w-16 h-16 rounded-xl overflow-hidden shadow-sm group bg-gray-100 flex-shrink-0">
                                                    @if($imageUrl)
                                                        <img src="{{ $imageUrl }}"
                                                    ...
                                                    <div class="{{ $imageUrl ? 'hidden' : 'flex' }} w-full h-full items-center justify-center bg-gray-200">
