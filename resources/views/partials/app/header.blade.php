<!-- Top Level Header (Utility Bar) -->
<div class="bg-dark text-white text-[11px] font-bold uppercase tracking-[0.2em] py-3">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        <div class="flex items-center gap-6">
            <span class="flex items-center gap-2">
                <svg class="w-3 h-3 text-primary" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M2.003 5.803l7.497 4.597 7.497-4.597A2 2 0 0015.523 4H4.477a2 2 0 00-1.474 1.803z"></path>
                    <path d="M18 8.118l-8 4.908-8-4.908V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
                </svg>
                support@anntix.com
            </span>
            <span class="hidden md:flex items-center gap-2">
                <svg class="w-3 h-3 text-primary" fill="currentColor" viewBox="0 0 20 20">
                    <path
                        d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 005.474 5.474l.772-1.548a1 1 0 011.06-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z">
                    </path>
                </svg>
                +62 821 1234 5678
            </span>
