    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div class="space-y-6">
                ...
                <div class="flex gap-4">
                    <a href="#"
                        ...
                        <svg class="w-4 h-4 text-white group-hover:text-white" fill="currentColor"
                            viewBox="0 0 24 24">
                            <path
            ...
            <div>
                ...
                <p class="text-xs text-white mb-4 font-medium leading-relaxed">Join our weekly newsletter to get the
