<footer class="bg-dark text-white pt-20 pb-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <!-- Links 1 -->
            <div>
                <h3 class="font-bold text-lg mb-6">Discover</h3>
                <ul class="space-y-4 text-gray-400">
                    <li><a href="{{ route('events.index') }}" class="hover:text-primary transition-colors">Upcoming
                            Events</a></li>
                    <li><a href="#" class="hover:text-primary transition-colors">Trending Now</a></li>
                    <li><a href="#" class="hover:text-primary transition-colors">By Category</a></li>
                    <li><a href="#" class="hover:text-primary transition-colors">By City</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-4 text-gray-400">
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <a href="tel:{{ preg_replace('/[^0-9+]/', '', $global_settings['contact_whatsapp'] ?? '+62 856-0045-7192') }}"
                            class="hover:text-primary transition-colors">{{ $global_settings['contact_whatsapp'] ?? '+62 856-0045-7192' }}</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="flex gap-6 text-sm">
                <a href="{{ route('pages.privacy') }}" class="text-gray-400 hover:text-white transition-colors">Privacy
                    Policy</a>
                <a href="{{ route('pages.terms') }}" class="text-gray-400 hover:text-white transition-colors">Terms of
                    Service</a>
                <a href="{{ route('pages.cookie') }}" class="text-gray-400 hover:text-white transition-colors">Cookie
                    Policy</a>
            </div>
        </div>
    </div>
