    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="lg:w-6/12 grid grid-cols-2 gap-8 md:gap-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-gray-400">
                        <li><a href="{{ route('pages.about') }}" class="hover:text-primary transition-colors">About Us</a></li>
                        <li><a href="{{ route('contact.index') }}" class="hover:text-primary transition-colors">Contact Support</a></li>
                        @guest
                    ...
                    <ul class="space-y-4 text-sm text-gray-400">
                        <li class="flex items-start gap-3">
                            ...
                            <a href="https://www.google.com/maps/search/?api=1&query={{ urlencode($global_settings['contact_location'] ?? 'Tegal, Jawa Tengah') }}"
                                target="_blank" class="hover:text-primary transition-colors leading-relaxed">
                        ...
                        <li class="flex items-center gap-3">
                            ...
                            <a href="mailto:{{ $global_settings['contact_email'] ?? 'hallo@anntix.com' }}"
                                class="hover:text-primary transition-colors">{{ $global_settings['contact_email'] ?? 'hallo@anntix.com' }}</a>
                        </li>
                        <li class="flex items-center gap-3">
                            <svg class="w-5 h-5 text-primary shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="flex gap-6 text-sm">
                <a href="{{ route('pages.privacy') }}" class="text-gray-500 hover:text-white transition-colors">Privacy</a>
                <a href="{{ route('pages.terms') }}" class="text-gray-500 hover:text-white transition-colors">Terms</a>
                <a href="{{ route('pages.cookie') }}" class="text-gray-500 hover:text-white transition-colors">Cookies</a>
            </div>
        </div>
    </div>
</footer>