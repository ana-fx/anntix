...
<body
    ...
    <div
        ...
        <div class="flex-1 text-center md:text-left space-y-8">
            <div
                ...
                <span class="text-xs font-bold tracking-widest uppercase text-blue-50">Traffic Limit Alert</span>
            </div>

            <h2 class="text-4xl md:text-6xl font-bold leading-tight tracking-tight">
                Rate limit<br>
                <span class="text-blue-200">exceeded.</span>
            </h2>

            <p class="text-lg text-blue-100 max-w-md mx-auto md:mx-0 leading-relaxed font-light opacity-90">
                You have made too many requests in a short period. Please wait a moment before trying again to ensure
                stability.
            </p>
        ...
        <div class="flex-1 relative flex items-center justify-center">
            ...
            <h1 class="relative text-[12rem] md:text-[16rem] leading-none font-black tracking-tighter text-transparent select-none"
                ...
                <span class="absolute inset-0 text-white/10 blur-sm transform translate-x-2 translate-y-2">429</span>
                <span
                    class="relative z-10 bg-clip-text text-transparent bg-gradient-to-br from-white to-blue-200 opacity-90">429</span>
            </h1>
        </div>
    ...
    <div class="absolute bottom-6 w-full text-center">
        <p class="text-blue-200/40 text-xs font-mono tracking-widest uppercase">ANNTIX ADMIN CONSOLE // ERROR_LOG_429
        </p>
    </div>
