        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <nav class="flex text-sm text-gray-500 mb-2 gap-2 items-center">
                    <a href="{{ route('organizer.events.index') }}" class="hover:text-primary transition-colors">My Events</a>
            ...
            <div class="lg:col-span-8 space-y-8">
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden group">
                    <div class="aspect-video relative overflow-hidden bg-gray-100">
                        @php
                            $banner = $event->banner_path;
                            $bannerUrl = $banner
                                ? (Str::startsWith($banner, 'http') ? $banner : (file_exists(public_path($banner)) ? asset($banner) : asset('storage/' . $banner)))
                                : null;
                        @endphp
                        @if($bannerUrl)
                            <img src="{{ $bannerUrl }}"
                            ...
                            <tbody class="divide-y divide-gray-100">
                                @forelse($event->tickets as $ticket)
                                    <tr class="hover:bg-gray-50/50 transition-colors">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="font-medium text-gray-900">{{ number_format($ticket->quota) }}</div>
                ...
                <!-- Assigned Scanners Table (Organizer View - Read Only) -->
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
                    <div class="flex items-center justify-between mb-6">
                        <h3 class="text-xl font-bold text-gray-900 flex items-center gap-2">
                        ...
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr
                                    ...
                                    <th class="px-6 py-4 text-dark rounded-tr-xl">Email</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-100">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="2" class="px-6 py-8 text-center text-gray-400 italic">
                                            No dedicated scanners assigned by Admin yet.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
                ...
                <!-- Assigned Resellers Table (Organizer View - Read Only) -->
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
                    <div class="flex items-center justify-between mb-6">
                        <h3 class="text-xl font-bold text-gray-900 flex items-center gap-2">
                            <svg class="w-5 h-5 text-primary" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="2" class="px-6 py-8 text-center text-gray-400 italic">
                                            No active resellers assigned by Admin yet.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
                        ...
                        <div class="space-y-5 mb-8">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-lg font-bold">{{ number_format($featuredTicket->quota) }} <span
                            ...
                            <div>
                                ...
                                @if($event->organizer_name)
                                    <div class="flex items-center gap-2">
                                        @php
                                            $logo = $event->organizer_logo_path;
                                            $logoUrl = $logo
                                                ? (Str::startsWith($logo, 'http') ? $logo : (file_exists(public_path($logo)) ? asset($logo) : asset('storage/' . $logo)))
                                                : null;
                                        @endphp
                                        @if($logoUrl)
                                            <img src="{{ $logoUrl }}"
