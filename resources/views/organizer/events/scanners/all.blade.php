<x-layouts.organizer>
    <x-slot name="title">All Scanners</x-slot>
    <div class="space-y-8">
        <div>
            <h2 class="text-3xl font-black text-dark tracking-tight">Active Scanners</h2>
            <p class="text-xs text-gray-500 font-bold uppercase tracking-wider mt-2">All ticket scanning agents across your events</p>
        </div>
                            ...
                            <tr class="hover:bg-primary/[0.02] transition-all group">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex flex-wrap gap-1.5">
                                        @foreach($scanner->scannedEvents as $event)
