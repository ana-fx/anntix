<x-layouts.organizer title="Transaction Details | {{ $transaction->code }}">
            ...
            <div class="bg-white rounded-[3rem] shadow-xl shadow-primary/5 border border-gray-100 p-10 lg:p-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div class="space-y-1 group">
                        ...
                        <div class="text-2xl font-bold text-dark tracking-tight">{{ $transaction->email }}</div>
                        <div class="text-xs font-black text-primary uppercase tracking-widest mt-1">{{ $transaction->phone }}</div>
                    </div>
                    <div class="space-y-1">
            ...
            <div class="bg-white rounded-[3rem] shadow-xl shadow-primary/5 border border-gray-100 p-10 lg:p-12">
                <div class="flex items-center justify-between mb-8">
                    ...
                    <div class="text-[10px] font-black text-gray-400 uppercase tracking-widest">
                        {{ $transaction->scans->count() }} / {{ $transaction->ticket->max_scans ?? 1 }} Scans
                    </div>
                </div>
            ...
            <div
                ...
                <div class="relative p-10">
                    ...
                    <div class="p-6 bg-white/[0.03] rounded-3xl text-center border border-white/5">
                        <div class="text-[9px] font-black text-teal-500 uppercase tracking-widest mb-1 italic">Channel Strategy</div>
                        <div class="text-sm font-black text-white/90 uppercase tracking-widest">
                            {{ $transaction->payment_type ?? 'ONLINE / MANUAL' }}</div>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-12 relative">
                    ...
                    @if($transaction->status === 'paid')
                        <div class="flex gap-8 relative group">
                            ...
                            <div>
                                <div class="text-[10px] font-black text-emerald-500 uppercase tracking-widest">Global Confirmed</div>
