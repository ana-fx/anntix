<x-layouts.organizer>
    <div class="max-w-4xl mx-auto">
        ...
        <form action="{{ route('organizer.resellers.update', $reseller) }}" method="POST" enctype="multipart/form-data"
            class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div x-data="{ photoPreview: '{{ $reseller->profile_photo_path ? asset('storage/' . $reseller->profile_photo_path) : null }}' }"
                            ...
                            <div class="text-sm">
                                <p class="text-gray-900 font-bold mb-1 italic">Update photo</p>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="address" value="{{ old('address', $reseller->address) }}"
                    ...
                    <!-- Password Section -->
                    <div class="space-y-2">
                        <label class="block text-sm font-bold text-gray-700 italic">New Password (Leave blank to keep
                            current)</label>
                    ...
                    <div class="space-y-2">
                        <label class="block text-sm font-bold text-gray-700 italic">Confirm New Password</label>
                    ...
                    <div class="md:col-span-2 space-y-2">
                        ...
                        <textarea name="bio" rows="3" placeholder="Tell us something about this reseller..."
                            class="w-full px-5 py-3 rounded-xl border border-gray-200 focus:border-primary focus:ring-4 focus:ring-primary/10 outline-none transition-all font-medium resize-none">{{ old('bio', $reseller->bio) }}</textarea>
